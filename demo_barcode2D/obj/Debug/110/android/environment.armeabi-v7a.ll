...
@__DSOCacheEntry_name.2 = internal constant [10 x i8] c"libIAL.so\00", align 1
@__DSOCacheEntry_name.3 = internal constant [24 x i8] c"libmono-profiler-log.so\00", align 1
@__DSOCacheEntry_name.4 = internal constant [22 x i8] c"libbarcodereader44.so\00", align 1
@__DSOCacheEntry_name.5 = internal constant [16 x i8] c"libmonodroid.so\00", align 1
@__DSOCacheEntry_name.6 = internal constant [17 x i8] c"libDeviceAPIQ.so\00", align 1
@__DSOCacheEntry_name.7 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 1
@__DSOCacheEntry_name.8 = internal constant [22 x i8] c"libbarcodereader43.so\00", align 1
@__DSOCacheEntry_name.9 = internal constant [17 x i8] c"libDeviceAPIM.so\00", align 1
@__DSOCacheEntry_name.10 = internal constant [21 x i8] c"libmiaxis-iso-lib.so\00", align 1
...
@__DSOCacheEntry_name.13 = internal constant [23 x i8] c"libIDFingerprintAlg.so\00", align 1
@__DSOCacheEntry_name.14 = internal constant [20 x i8] c"libbarcodereader.so\00", align 1
@__DSOCacheEntry_name.15 = internal constant [10 x i8] c"libSDL.so\00", align 1
...
@dso_cache = local_unnamed_addr global [64 x %struct.DSOCacheEntry] [
	...
	; 1
	%struct.DSOCacheEntry {
		i64 115368998, ; hash 0x6e06426, from name: libIAL
		i8 0, ; ignore
	...
	; 3
	%struct.DSOCacheEntry {
		i64 188347377, ; hash 0xb39f3f1, from name: barcodereader44.so
		i8 0, ; ignore
	...
	; 5
	%struct.DSOCacheEntry {
		i64 269910990, ; hash 0x101683ce, from name: libDeviceAPIQ.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 6
	%struct.DSOCacheEntry {
	...
	; 7
	%struct.DSOCacheEntry {
		i64 408987831, ; hash 0x1860a8b7, from name: libbarcodereader43.so
		i8 0, ; ignore
	...
	; 8
	%struct.DSOCacheEntry {
		i64 697859197, ; hash 0x29987c7d, from name: IAL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 11
	%struct.DSOCacheEntry {
		i64 828379841, ; hash 0x316012c1, from name: DeviceAPIM.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 12
	%struct.DSOCacheEntry {
		i64 845840969, ; hash 0x326a8249, from name: libmiaxis-iso-lib.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 13
	%struct.DSOCacheEntry {
	...
	; 14
	%struct.DSOCacheEntry {
		i64 1145957388, ; hash 0x444dec0c, from name: barcodereader43
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 17
	%struct.DSOCacheEntry {
		i64 1387846732, ; hash 0x52b8dc4c, from name: IAL
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 19
	%struct.DSOCacheEntry {
		i64 1561372662, ; hash 0x5d10a7f6, from name: libIDFingerprintAlg.so
		i8 0, ; ignore
	...
	; 20
	%struct.DSOCacheEntry {
		i64 1717782919, ; hash 0x66634987, from name: barcodereader43.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 21
	%struct.DSOCacheEntry {
		i64 1728527442, ; hash 0x67073c52, from name: libbarcodereader44.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 23
	%struct.DSOCacheEntry {
		i64 1857309049, ; hash 0x6eb44979, from name: libbarcodereader.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 24
	%struct.DSOCacheEntry {
		i64 1882275552, ; hash 0x70313ee0, from name: miaxis-iso-lib.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 25
	%struct.DSOCacheEntry {
		i64 1971905035, ; hash 0x7588e20b, from name: libSDL
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 26
	%struct.DSOCacheEntry {
	...
	; 27
	%struct.DSOCacheEntry {
		i64 2117324701, ; hash 0x7e33cf9d, from name: DeviceAPIQ.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 28
	%struct.DSOCacheEntry {
		i64 2120806936, ; hash 0x7e68f218, from name: IDFingerprintAlg
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.13, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 30
	%struct.DSOCacheEntry {
		i64 2254100605, ; hash 0x865ad87d, from name: SDL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 31
	%struct.DSOCacheEntry {
		i64 2381564063, ; hash 0x8df3c89f, from name: barcodereader.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 35
	%struct.DSOCacheEntry {
		i64 2734535114, ; hash 0xa2fdb1ca, from name: SDL
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 36
	%struct.DSOCacheEntry {
		i64 2762032625, ; hash 0xa4a145f1, from name: libbarcodereader43
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 37
	%struct.DSOCacheEntry {
		i64 2842798406, ; hash 0xa971a946, from name: DeviceAPIM
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 39
	%struct.DSOCacheEntry {
		i64 2858278225, ; hash 0xaa5ddd51, from name: libDeviceAPIQ
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 41
	%struct.DSOCacheEntry {
		i64 2915603190, ; hash 0xadc892f6, from name: libmiaxis-iso-lib
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 42
	%struct.DSOCacheEntry {
		i64 3024549463, ; hash 0xb446f657, from name: miaxis-iso-lib
		i8 0, ; ignore
		i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 44
	%struct.DSOCacheEntry {
		i64 3262400600, ; hash 0xc2744858, from name: libSDL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.15, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 46
	%struct.DSOCacheEntry {
		i64 3418580225, ; hash 0xcbc36501, from name: libDeviceAPIM
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 48
	%struct.DSOCacheEntry {
		i64 3571557134, ; hash 0xd4e1a30e, from name: libbarcodereader
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 50
	%struct.DSOCacheEntry {
		i64 3594197579, ; hash 0xd63b1a4b, from name: libbarcodereader44
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 51
	%struct.DSOCacheEntry {
		i64 3594222840, ; hash 0xd63b7cf8, from name: libIAL.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 54
	%struct.DSOCacheEntry {
		i64 3673602651, ; hash 0xdaf6ba5b, from name: DeviceAPIQ
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 56
	%struct.DSOCacheEntry {
		i64 3721318802, ; hash 0xddced192, from name: IDFingerprintAlg.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.13, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 57
	%struct.DSOCacheEntry {
		i64 3754731522, ; hash 0xdfcca802, from name: barcodereader
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.14, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 61
	%struct.DSOCacheEntry {
		i64 4022596500, ; hash 0xefc3f394, from name: barcodereader44
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 62
	%struct.DSOCacheEntry {
		i64 4162275513, ; hash 0xf81748b9, from name: libIDFingerprintAlg
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.13, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 63
	%struct.DSOCacheEntry {
		i64 4271550129, ; hash 0xfe9aaeb1, from name: libDeviceAPIM.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}
